...
struct InputTextCallback_UserData //CHANGES
{
	std::string*            Str;
...
static int InputTextCallback(ImGuiInputTextCallbackData* data)//CHANGES
{
...
bool ImGui::InputTextDynamic(const char* label, std::string* str, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)//CHANGES
{
